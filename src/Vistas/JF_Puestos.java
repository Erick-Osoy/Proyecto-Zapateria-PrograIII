 ...
 * @author Erick E. Osoy
 */
public class JF_Puestos extends javax.swing.JFrame {

    Calendar fecha = new GregorianCalendar();
    DefaultTableModel modelo = new DefaultTableModel();
    Form_Puestos_Editar editarform = new Form_Puestos_Editar();
    ...
    private void initComponents() {
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/settings_22px.png"))); // NOI18N
        jLabel13.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, -1, 40));
        ...
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 540, 30, 30));
        ...
        jLabel3.setText("Administracion de puestos");
        ...
        jPanel1.add(lblFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 0, 110, 20));

        lblHora.setFont(new java.awt.Font("Gadugi", 1, 14)); // NOI18N
        lblHora.setForeground(new java.awt.Color(255, 255, 255));
        lblHora.setText("Hora");
        jPanel1.add(lblHora, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 0, 120, 20));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 300, 770, 330));
        ...
        jPanel8.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 10, 270, 40));
        ...
        jPanel8.add(btnEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 10, 120, 40));
        ...
        jPanel8.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 270, 40));

        jPanel1.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, 740, 60));
        ...
        jPanel1.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 270, 270, 30));
    ...
    private void btnAgregarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarMousePressed
        ...
        ControladorPuestos controlador = new ControladorPuestos(form);
        form.setVisible(true);
    }//GEN-LAST:event_btnAgregarMousePressed

    private void btnEditarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarMousePressed
        editarPuesto();
        ControladorPuestos controlador = new ControladorPuestos(editarform);       
    ...
    public void editarPuesto(){
        int fila = this.tabla.getSelectedRow();
            ...
            if(fila == -1){
                ...
                String nombre = (String)this.tabla.getValueAt(fila, 1);
