 ...
 * @author Erick E. Osoy
 */
public class JF_Proveedores extends javax.swing.JFrame {

    Calendar fecha = new GregorianCalendar();
    Form_Proveedores agregar = new Form_Proveedores();
    Form_Proveedores_Editar editar = new Form_Proveedores_Editar();
    
    public JF_Proveedores() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Administracion de proveedores");
        ...
        jPanel1.add(lblFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 0, 120, -1));

        lblHora.setFont(new java.awt.Font("Gadugi", 1, 14)); // NOI18N
        lblHora.setForeground(new java.awt.Color(255, 255, 255));
        lblHora.setText("Hora");
        jPanel1.add(lblHora, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 0, 130, 20));
        ...
        jPanel8.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 10, 270, 40));
        ...
        jPanel8.add(btnEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 10, 120, 40));

        jPanel1.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 170, 770, 60));

        btnActualizar1.setBackground(new java.awt.Color(33, 47, 60));
        btnActualizar1.setFont(new java.awt.Font("DialogInput", 1, 14)); // NOI18N
        ...
        jPanel1.add(btnActualizar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 260, 270, 30));
    ...
    private void btnAgregarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarMousePressed
       ControladorProveedor controladorP = new ControladorProveedor(agregar);
       agregar.setVisible(true);
    }//GEN-LAST:event_btnAgregarMousePressed

    private void btnEditarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarMousePressed
        ActualizarProveedor();
        ControladorProveedor controladorP = new ControladorProveedor(editar);
    ...
    public void ActualizarProveedor(){
        int fila = this.tabla.getSelectedRow();    
            ...
            if(fila == -1){
                ...
                String telefono = (String)this.tabla.getValueAt(fila, 2);
                String correo = (String)this.tabla.getValueAt(fila, 3);
