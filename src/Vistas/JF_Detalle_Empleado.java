 ...
 * @author Erick E. Osoy
 */
public class JF_Detalle_Empleado extends javax.swing.JFrame {

    Calendar fecha = new GregorianCalendar();
    DefaultTableModel modelo = new DefaultTableModel();
    
    Form_Detalle agregar = new Form_Detalle();
    Form_Detalle_Editar editar = new Form_Detalle_Editar();

    
    public JF_Detalle_Empleado() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(lblHora, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 0, 140, 20));
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "User", "Pass", "Sueldo", "Descuentos", "Total", "Horas", "H Extra", "Empleado"
            }
        ) {
    ...
    private void btnAgregarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarMousePressed
        ControladorDetalleEmpleado controlador = new ControladorDetalleEmpleado(agregar);
        agregar.setVisible(true);
    }//GEN-LAST:event_btnAgregarMousePressed

    private void btnEditarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarMousePressed
        editarDetalle();
        ControladorDetalleEmpleado controlador = new ControladorDetalleEmpleado(editar);
    ...
    public void editarDetalle(){
        ...
        if(fila == -1){
            ...
            String user = (String)this.tabla.getValueAt(fila, 1).toString();
            String pass = (String)this.tabla.getValueAt(fila, 2).toString();
            Double sueldo = Double.parseDouble((String)this.tabla.getValueAt(fila, 3).toString());
            Double descuentos = Double.parseDouble((String)this.tabla.getValueAt(fila, 4).toString());
            Double total = Double.parseDouble((String)this.tabla.getValueAt(fila, 5).toString());
            Double hora = Double.parseDouble((String)this.tabla.getValueAt(fila, 6).toString());
            Double extras = Double.parseDouble((String)this.tabla.getValueAt(fila, 7).toString());
            int empleado = Integer.parseInt((String)this.tabla.getValueAt(fila, 8).toString());
            
            editar.txtID.setText(""+id);
            editar.txtUser.setText(user);
            editar.txtPass.setText(pass);
            editar.txtSueldo.setText(""+sueldo);
            editar.txtDescuentos.setText(""+descuentos);
            editar.txtTotal.setText(""+total);
            editar.txtHoras.setText(""+hora);
            editar.txtExtras.setText(""+extras);
            editar.txtEmpleado.setText(""+empleado);
