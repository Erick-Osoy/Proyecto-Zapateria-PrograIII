...
public class JF_Productos extends javax.swing.JFrame {
    ...
    Form_Productos_Editar editarform = new Form_Productos_Editar();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Administracion de Productos");
        ...
        jPanel1.add(lblFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 0, 120, 20));

        lblHora.setFont(new java.awt.Font("Gadugi", 1, 14)); // NOI18N
        lblHora.setForeground(new java.awt.Color(255, 255, 255));
        lblHora.setText("Hora");
        jPanel1.add(lblHora, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 0, 120, -1));
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Cantidad", "Precio", "Total", "Proveedor"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 280, 770, 350));
        ...
        jPanel8.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 10, 160, 40));
        ...
        jPanel8.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 10, 160, 40));
        ...
        jPanel8.add(btnEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 10, 160, 40));

        jPanel1.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, 750, 60));

        btnActualizar.setBackground(new java.awt.Color(33, 47, 60));
        btnActualizar.setFont(new java.awt.Font("DialogInput", 1, 14)); // NOI18N
        ...
        jPanel1.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 250, 270, 30));
    ...
    private void btnEditarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarMousePressed
        editar();
        ControladorProducto controlador = new ControladorProducto(editarform);
    }//GEN-LAST:event_btnEditarMousePressed

    private void btnAgregarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarMousePressed
        Form_Productos form = new Form_Productos();
        ControladorProducto controlador = new ControladorProducto(form);
    ...
    public void editar(){
        ...
        if(fila == -1){
            ...
            int cantidad = Integer.parseInt((String)this.tabla.getValueAt(fila, 2).toString());
            Double precio = Double.parseDouble((String)this.tabla.getValueAt(fila, 3).toString());
            Double total = Double.parseDouble((String)this.tabla.getValueAt(fila, 4).toString());
            int proveedor = Integer.parseInt((String)this.tabla.getValueAt(fila, 5).toString());
            
            editarform.txtID.setText(""+id);
            editarform.txtNombre.setText(nombre);
            editarform.txtCantidad.setText(""+cantidad);
            editarform.txtPrecio.setText(""+precio);
            editarform.txtTotal.setText(""+total);
            editarform.txtProveedor.setText(""+proveedor);
